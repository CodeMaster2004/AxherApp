...
public class ContentService {
    ...
    public Page<Content> findAll(Pageable pageable, String search){
        ...
        if(search != null && !search.isEmpty()){
            ...
            return contentRepository.searchByTitle(search, pageable);
        }
    ...
    private Content buildAndSaveContent(CreateContentDto dto){
        ...
        Language originalLanguage = getValidatedLanguage(dto.getOriginalLanguageId());
    ...
    private Language getValidatedLanguage(Integer languageId){

        return languageRepository.findById(languageId)
            .filter(Language::getActive)
            .orElseThrow(() ->
                new ResourceNotFoundException("Idioma no encontrado o inactivo: " + languageId)
            );
                ...
                contentTranslationRepository
                        ...
                        .orElseThrow(() ->
                                new ResourceNotFoundException(
                                        "Traducción original no encontrada para el contenido: "
                                             + content.getContentId()
