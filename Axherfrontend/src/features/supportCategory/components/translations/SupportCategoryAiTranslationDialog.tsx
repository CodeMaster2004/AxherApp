import { LanguageResponse, SupportCategoryTranslationResponse } from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: SupportCategoryTranslationResponse;
...
export default function SupportCategoryAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
