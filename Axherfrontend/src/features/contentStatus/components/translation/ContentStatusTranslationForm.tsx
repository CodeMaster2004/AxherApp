...
import { ContentStatusTranslationRequest } from "@/entities/types/status.types";
...
interface Props {
    ...
    value: ContentStatusTranslationRequest;
    onChange: (
        value: ContentStatusTranslationRequest
    ) => void;
    onSubmit: () => void;
...
export default function ContentStatusTranslationForm({
