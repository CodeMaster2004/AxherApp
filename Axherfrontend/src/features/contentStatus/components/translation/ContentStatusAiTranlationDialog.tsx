...
import { ContentStatusTranslationResponse } from "@/entities/types/status.types";
...
interface Props {
    open: boolean;
    sourceTranslation: ContentStatusTranslationResponse;
...
export default function ContentStatusAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
