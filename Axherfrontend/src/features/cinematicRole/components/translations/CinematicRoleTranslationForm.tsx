...
import { CinematicRoleTranslationRequest, LanguageResponse } from "@/entities/types";
...
interface Props {
    ...
    value: CinematicRoleTranslationRequest;
    onChange: (
        value: CinematicRoleTranslationRequest
    ) => void;
    onSubmit: () => void;
...
export default function CinematicRoleTranslationForm({
    languages,
    value,
    onChange,
    onSubmit,
