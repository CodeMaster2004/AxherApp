...
import {CinematicRoleTranslationResponse, LanguageResponse,} from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: CinematicRoleTranslationResponse;
...
export default function CinematicRoleAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
