...
import { CinematicRoleTranslationResponse } from "@/entities/types";
...
interface Props {
    translations: CinematicRoleTranslationResponse[];
...
export default function CinematicRoleTranslationList({
    translations,
    deleting,
    onDelete,
    onEdit,
