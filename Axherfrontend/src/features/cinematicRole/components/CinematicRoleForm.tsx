...
import {CinematicRoleRequest,LanguageResponse,} from "@/entities/types";
...
interface Props {
    value: CinematicRoleRequest;
    onChange: React.Dispatch<
        React.SetStateAction<CinematicRoleRequest>
    >;
...
export default function CinematicRoleForm({
    value,
    onChange,
    onSubmit,
    isEditing,
