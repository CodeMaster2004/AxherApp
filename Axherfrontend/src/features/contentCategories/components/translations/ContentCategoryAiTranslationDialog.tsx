import { ContentCategoryAiTranslationResponse, ContentCategoryTranslationResponse, LanguageResponse } from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: ContentCategoryTranslationResponse;
...
export default function ContentCategoryAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
