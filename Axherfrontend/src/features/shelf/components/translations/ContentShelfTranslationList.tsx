...
import { ContentShelfTranslationResponse } from "@/entities/types";
...
interface Props {
    translations: ContentShelfTranslationResponse[];
...
export default function ContentShelfTranslationList({
    translations,
    deleting,
    onDelete,
    onEdit,
    ...
    return (
        <>
            <ConfirmDialog
                ...
                title={t("translation.deleteTitle")}
                message={t("translation.deleteMessage", {
                    languageName:
                        confirmDialog.languageName,
                })}
