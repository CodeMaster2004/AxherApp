import { LanguageResponse, ReportStatusTranslationResponse } from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: ReportStatusTranslationResponse;
...
export default function ReportStatusAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
