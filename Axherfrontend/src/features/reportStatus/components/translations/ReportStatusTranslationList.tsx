...
import { ReportStatusTranslationResponse } from "@/entities/types/reportStatus.types";
...
interface Props {
    translations: ReportStatusTranslationResponse[];
...
export default function ReportStatusTranslationList({
    ...
    const handleConfirmDelete = async () => {
        await onDelete(confirmDialog.languageId);
    ...
    if (translations.length === 0) {
        return <p>{common("translation.empty")}</p>;
    }
    ...
    return (
        <>
            <ConfirmDialog
                ...
                title={common("translation.deleteTitle")}
                message={common("translation.deleteMessage", { name: confirmDialog.languageName })}
