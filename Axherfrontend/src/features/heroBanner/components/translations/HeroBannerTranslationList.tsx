...
import {HeroBannerTranslationResponse,} from "@/entities/types/heroBanner.types";
...
interface Props {
    translations: HeroBannerTranslationResponse[];
...
export default function HeroBannerTranslationList({
    translations,
    deleting,
    onDelete,
    onEdit,
    ...
    return (
        <>
            ...
            <ConfirmDialog
                ...
                message={t("translations.deleteMessage" , { languageName: confirmDialog.languageName })}
