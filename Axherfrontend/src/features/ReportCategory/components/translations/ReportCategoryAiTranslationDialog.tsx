import { LanguageResponse, ReportCategoryTranslationResponse } from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: ReportCategoryTranslationResponse;
...
export default function ReportCategoryAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
