...
import { ReportCategoryTranslationResponse } from "@/entities/types";
...
interface Props {
    translations: ReportCategoryTranslationResponse[];
...
export default function ReportCategoryTranslationList({
        ...
        <>
            ...
            <ConfirmDialog
                ...
                message={t("translations.deleteMessage", {
                    languageName: confirmDialog.languageName,
                })}
