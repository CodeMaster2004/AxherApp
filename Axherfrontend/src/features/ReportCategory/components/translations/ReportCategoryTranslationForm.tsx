...
import { LanguageResponse, ReportCategoryTranslationRequest } from "@/entities/types";
...
interface Props {
    ...
    value: ReportCategoryTranslationRequest;
    onChange: (
        value: ReportCategoryTranslationRequest
    ) => void;
    onSubmit: () => void;
...
export default function ReportCategoryTranslationForm({
