import { LanguageResponse, SupportTicketStatusTranslationResponse } from "@/entities/types";
...
interface Props {
    open: boolean;
    sourceTranslation: SupportTicketStatusTranslationResponse;
...
export default function SupportTicketStatusAiTranslationDialog({
    open,
    sourceTranslation,
    languages,
    onConfirm,
