...
import { ContentTranslation } from "@/entities/types";
    ...
    return (
        <>
            <ConfirmDialog
                ...
                message={`¿Estás seguro de que deseas eliminar la traducción en "${confirmDialog.languageName}"? Esta acción no se puede deshacer.`}
